...
labels = { 0: 'cloth', 1: 'none',
          2: 'respirator', 3: 'surgical', 4: 'valve'}

roots = '/home/bringascastle/Escritorio/datasets/MM_Dataset/valid/'
#roots = '/Users/agustincastillo/Downloads/JPEGImages04res/'
carpeta_imagenes = 'JPEGImages' 
...
def getPathImgXML(root, annotations='annotations', images='images'):
    ...
    print("Hubieron {} inapropiadas y {} errores de deteccion". format(
        inapropiate, errors))
    return annot, imgs
...
def generateJSONFile():
    ...
    '''
    annot, imgs = getPathImgXML(roots,
                                annotations='Annotations', images=carpeta_imagenes)
